...
**Type** Cowork skill  ·  **Trigger** Any instruction to file a message or exchange as a good or bad example
...
The library only compounds if filing is selective and honest. The anti-pattern labelling rule is the one that earns its keep most often, failure examples are more instructive than successes but only when the reader cannot mistake which is which.
